...
Иконка ТОЙХАНА появится на рабочем столе. При запуске приложение откроется в полноэкранном режиме без браузерных панелей, как настоящее нативное приложение.
